...
#subject to linearjabr_c {i in branches}: 2 * c[i] <= v[bus_f[i]] + v[bus_t[i]];

#subject to linearjabr_cplus1 {i in branches}: 2 * c[i] <= 0.41421356237 * v[bus_f[i]] + 1.41421356237 * v[bus_t[i]];

#subject to linearjabr_cplus2 {i in branches}: 2 * c[i] <= 1.41421356237 * v[bus_f[i]] + 0.41421356237 * v[bus_t[i]];

#subject to linearjabr_s {i in branches}: 2 * s[i] <= v[bus_f[i]] + v[bus_t[i]];

#subject to linearjabr_splus1 {i in branches}: 2 * s[i] <= 0.41421356237 * v[bus_f[i]] + 1.41421356237 * v[bus_t[i]];

#subject to linearjabr_splus2 {i in branches}: 2 * s[i] <= 1.41421356237 * v[bus_f[i]] + 0.41421356237 * v[bus_t[i]];

subject to Ploss {i in branches}: Pf[i] + Pt[i] >= 0;
