...
param t_jabr {1..num_jabr_cuts};
param c_jabr {1..num_jabr_cuts};
param s_jabr {1..num_jabr_cuts};
param vk_vm_jabr {1..num_jabr_cuts};
...
subject to j_cuts {(i,j) in jabr_cuts}: 
    t_jabr[i] * ( v[bus_f[j]] + v[bus_t[j]] ) >= c_jabr[i] * 2 * c[j] + s_jabr[i] * 2 * s[j] + vk_vm_jabr[i] * (v[bus_f[j]] - v[bus_t[j]]);


#subject to j_cuts {i in 1..num_jabr_cuts}: t_jabr[jabr_cuts[i]] >= 0;
#    t_jabr[jabr_cuts[i]] * ( v[bus_f[jabr_cuts[i]]] + v[bus_t[jabr_cuts[i]]] ) >= c_jabr[jabr_cuts[i]] * 2 * c[jabr_cuts[i]] + s_jabr[jabr_cuts[i]] * 2 * s[jabr_cuts[i]] + vk_vm_jabr[jabr_cuts[i]] * (v[bus_f[jabr_cuts[i]]] - v[bus_t[jabr_cuts[i]]]);
