...
def cutjabr_9(log,all_data):
    ...
    all_data['max_error_rnd'] = 0
    all_data['most_violated_branch_rnd'] = 'NONE'
    ...
    for i in most_violated.keys():
        ...
        jabr_cuts[(num_cuts + most_violated_count,i)] = (rnd,most_violated[i],coeff_cft,coeff_sft,coeff_vf,coeff_vt,threshold)
    ...
    all_data['total_jabrs'] += most_violated_count
    ...
    all_data['most_violated_branch_rnd'] = most_violated_branch
    all_data['max_error_rnd'] = max_error
