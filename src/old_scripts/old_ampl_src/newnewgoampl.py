...
def newgoampl(log,all_data):
    ...
    ampl.eval("option print_precision;")
    ...
    for branch in all_data['branches'].values():
        ...
        reverse_branches[(branch.id_f,branch.id_t)] = branchcount
    ...
    ampl.get_parameter('Bft').setValues(Bft) #before 'Bft' but Btf...
    ...
    #compute max gen - demand and min gen - demand 
