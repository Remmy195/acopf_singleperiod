...
def writesol(log,all_data):
    ...
    if all_data['modfile'] == 'jabr.mod' or all_data['modfile'] == 'jabr_mtp.mod' or all_data['modfile'] == 'jabr_mosek.mod':
        if all_data['solver'] == 'knitroampl':
            ...
            filename      = 'JABRsol_gurobi_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.txt'
            #filename      = 'SOCPsols' + datenow + '/JABRsol_gurobi_' + all_data['casename'] + '.txt'
        elif all_data['solver'] == 'mosek':
            filename      = 'JABRsol_mosek_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.txt'
        ...
        if all_data['solver'] == 'knitroampl':
            filename      = 'I2sol_knitro_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.txt'
            #filename      = 'SOCPsols' + datenow + '/I2sol_knitro_' + all_data['casename'] + '.txt'                               
        elif all_data['solver'] == 'gurobi_ampl':
            filename      = 'I2sol_gurobi_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.txt'
            #filename      = 'SOCPsols' + datenow + '/I2sol_gurobi_' + all_data['casename'] + '.txt'                        
        elif all_data['solver'] == 'mosek':
            filename      = 'I2sol_mosek_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.txt'
    ...
    for genid in gens.keys():
        for k in range(T):
            gen     = gens[genid] 
            nodeID  = gen.nodeID
            line_gen = 'genid ' + str(genid) + ' bus ' + str(nodeID) + ' GP ' + str(GenPvalues[genid]) + ' GQ ' + str(GenQvalues[genid]) + ' k ' + str(k) + '\n'
...
def writesol_allvars(log,all_data):
    ...
    if all_data['modfile'] == 'jabr.mod' or all_data['modfile'] == 'jabr_mtp.mod' or all_data['modfile'] == 'jabr_mosek.mod':
        if all_data['solver'] == 'knitroampl':
            filename      = 'JABRsol_knitro_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.sol'
            #filename      = 'SOCPsols' + datenow + '/JABRsol_knitro_' + all_data['casename'] + '.sol'
        elif all_data['solver'] == 'gurobi_ampl':
            filename      = 'JABRsol_gurobi_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.sol'
            #filename      = 'SOCPsols' + datenow + '/JABRsol_gurobi_' + all_data['casename'] + '.sol'
        elif all_data['solver'] == 'mosek':
            filename      = 'JABRsol_mosek_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.sol'
            #filename      = 'SOCPsols' + datenow + '/JABRsol_mosek_' + all_data['casename'] + '.sol'
    elif all_data['modfile'] == 'i2.mod' or all_data['modfile'] == 'i2_mosek.mod':
        if all_data['solver'] == 'knitroampl':
            filename      = 'I2sol_knitro_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.sol'
            #filename      = 'SOCPsols' + datenow + '/I2sol_knitro_' + all_data['casename'] + '.sol'                               
        elif all_data['solver'] == 'gurobi_ampl':
            filename      = 'I2sol_gurobi_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.sol'
            #filename      = 'SOCPsols' + datenow + '/I2sol_gurobi_' + all_data['casename'] + '.sol'                        
        elif all_data['solver'] == 'mosek':
            filename      = 'I2sol_mosek_' + all_data['casename'] + '_' + str(T) + '_' + casetype + '.sol'
...
def gosocp_mosek_mtp(log,all_data):
    ...
    solver_options = "option mosek_options 'tech:optionnativeread=/opt/newampl/mosekopt outlev=1 sol:chk:feastol=1e-08 chk:mode=2' ;"
